export const Footer = () => {
  return (
    <footer className="mt-28 bg-light-gray flex w-full justify-between items-center px-10 py-2 h-14">
      <div className="text-lg">Copyright @2024 TimeTrek. All rights reserved</div>

      <div className="flex justify-between w-2/5 font-light">
        <a href="/">Privacy</a>
      ...
      <div className="flex justify-center items-center">
        <div className="font-light">Eng</div>
